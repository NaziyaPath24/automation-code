Feature: feature to test the functionality of Company Registration in Ems application
  ...
  Scenario Outline: User to register company with valid detail
    ...
    Then user selects company type as "Private Limited"`
    When user enters valid details as <company name> and <service name> and <company email id> and <password> and <contact number> and <alternate number> and <company address> and <company cin number> and <company gst number> and <company pan number> and <name> and <personal email id> and <personal mobile number> and <address>
